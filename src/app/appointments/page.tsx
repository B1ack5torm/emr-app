...
export default function AppointmentsPage() {
  ...
  const update = async (id: string, action: "check-in" | "cancel") => {
    ...
    const res = await fetch(`/api/appointments/${id}`, { method: "PATCH", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ action, reason }) });
