...
import { Stethoscope, ClipboardList, FileText, LogOut, ShieldCheck, Receipt, CalendarDays, Pill } from "lucide-react";
...
export default function NavBar() {
  ...
  const tabs = [
    ...
    { href: "/pharmacy", label: "Pharmacy", icon: <Pill size={15} />, roles: ["PHARMACIST", "ADMIN"] },
    { href: "/records", label: "Patient Records", icon: <FileText size={15} />, roles: ["RECEPTION", "DOCTOR", "PHARMACIST", "ADMIN"] },
